...
favicon_paths = ['apple-icon-180x180.png', 'apple-icon-114x114.png', 'android-icon-72x72.png',
                 'apple-icon-57x57.png', 'apple-icon-72x72.png', 'apple-icon.png', 'ms-icon-70x70.png',
                 'android-icon-36x36.png', 'apple-icon-precomposed.png', 'apple-icon-76x76.png',
                 'apple-icon-60x60.png', 'android-icon-96x96.png', 'ms-icon-144x144.png', 'ms-icon-150x150.png',
                 ...
                 'apple-icon-144x144.png', 'browserconfig.xml', 'manifest.json',
                 'apple-icon-120x120.png', 'ms-icon-310x310.png']
